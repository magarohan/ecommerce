...
class _CheckoutScreenState
  ...
  Widget
    ...
    int subtotal =
        _calculateSubtotal();
    int shipping = cartItems.isEmpty
        ? 0
        : 100;
    int total =
        subtotal + shipping;
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Container(
            ...
            decoration: const BoxDecoration(color: MyColors.backgroundColor2, borderRadius: BorderRadius.all(Radius.circular(8))),
            child: const Row(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _buildSummaryRow("Shipping Cost", "Rs. $shipping"),
                const Divider(),
                _buildSummaryRow("Total", "Rs. $total", isBold: true),
              ],
            ),
          ),
          SizedBox(
